    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'patterns',
            loadChildren: () => import('./patterns/patterns.routes').then((m) => m.patternRoutesWithTitle)
          }
        ]
      },
      {
      ...
      {
        path: 'services',
        loadChildren: () => import('./services/services.routes').then((m) => m.servicesRoutesWithTitle)
      }
    ]
  },
  {
