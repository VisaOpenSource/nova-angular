...
export const iconRoutes: Routes = [
	...
	{ loadComponent: () => import('./error/error.docs').then(m => m.ErrorIconComponent), path: 'error', title: 'Error icon component | Example' + TITLE_SEPARATOR + TITLE_SUFFIX },
	...
	{ loadComponent: () => import('./success/success.docs').then(m => m.SuccessIconComponent), path: 'success', title: 'Success icon component | Example' + TITLE_SEPARATOR + TITLE_SUFFIX },
	...
	{ loadComponent: () => import('./warning/warning.docs').then(m => m.WarningIconComponent), path: 'warning', title: 'Warning icon component | Example' + TITLE_SEPARATOR + TITLE_SUFFIX }
];
