...
export class ModelDrivenFormSelectComponent {
  readonly input1 = new FormControl({ value: '', disabled: false }, [Validators.required]);
  readonly input2 = new FormControl({ value: '', disabled: true }, [Validators.required]);
  readonly input3 = new FormControl({ value: '', disabled: false }, [Validators.required]);
