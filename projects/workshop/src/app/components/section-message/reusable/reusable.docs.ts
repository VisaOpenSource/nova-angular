...
import { ReusableSectionMessage } from './reusable-component/reusable-component.docs';
 ...
 */
@Component({
  selector: 'nova-reusable-section-message-demo',
  imports: [NovaLibModule, ReusableSectionMessage, DynamicReusableForm],
  templateUrl: './reusable.docs.html',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReusableSectionMessageDemo {
  readonly name = 'reusable-section-message-demo';
  ...
  protected propertyConfigs: PropertyConfig[] = [
    ...
    },
    {
      name: 'description',
      type: 'string',
      defaultValue: 'This is required text that describes the section message in more detail.',
      label: 'Description'
    },
    {
      name: 'messageType',
