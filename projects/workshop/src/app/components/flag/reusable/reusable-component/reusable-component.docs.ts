...
/** #AI-first */
@Component({
  selector: 'nova-reusable-flag',
  imports: [NovaLibModule, VisaErrorLow, VisaInformationLow, VisaSuccessLow, VisaWarningLow, VisaCloseTiny, RouterLink],
  templateUrl: './reusable-component.docs.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReusableFlag {
  // Unique ID for the input
  private readonly generatedId = inject(IdGenerator).newId('reusable-flag');
