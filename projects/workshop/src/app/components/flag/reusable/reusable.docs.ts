...
import { ReusableFlag } from './reusable-component/reusable-component.docs';
 ...
 */
@Component({
  selector: 'nova-reusable-flag-demo',
  imports: [NovaLibModule, ReusableFlag, DynamicReusableForm],
  templateUrl: './reusable.docs.html',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReusableFlagDemo {
  readonly name = 'reusable-flag-demo';
  ...
  protected propertyConfigs: PropertyConfig[] = [
    ...
    },
    {
      name: 'description',
      type: 'string',
      defaultValue: 'This is required text that describes the flag in more detail.',
      label: 'Description'
    },
    {
      name: 'messageType',
      ...
      label: 'Message type',
      options: ['success', 'information', 'warning', 'error'].map((type) => ({
