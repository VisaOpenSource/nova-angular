...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, NovaLibModule, VisaClearAltTiny, VisaChevronDownTiny, VisaChevronUpTiny]
})
export class ModelDrivenMultiselectComponent {
  readonly comboboxFormControl = new FormControl({ label: 'Option A', value: 'option-a' });
