...
import { PackageInstallerComponent } from '../../shared/app-components/package-installer/package-installer.component';
...
export class DialogDocsComponent {
  readonly cdkVersion = packageJson?.dependencies['@angular/cdk'];
