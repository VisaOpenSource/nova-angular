...
@Component({
  ...
  selector: 'nova-workshop-default-list-with-section-title-and-hyperlink',
  standalone: true,
  imports: [NovaLibModule, VisaChevronRightTiny],
  templateUrl: './default-list-with-section-title-and-hyperlink.docs.html'
})
export class DefaultListWithSectionTitleAndHyperlinkComponent {
  items = [
