...
import { ListboxOption, ReusableListbox } from './reusable-component/reusable-component.docs';
 ...
 */
@Component({
  selector: 'nova-reusable-listbox-demo',
  imports: [NovaLibModule, ReusableListbox, DynamicReusableForm],
  templateUrl: './reusable.docs.html',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReusableListboxDemo {
  readonly name = 'reusable-listbox-demo';
  ...
  protected propertyConfigs: PropertyConfig[] = [
    ...
    },
    {
      ...
      helpText:
        'Each option should be an object with "label" and "value" properties, and optionally "disabled" and "active".'
    },
    {
      name: 'autoSelect',
      type: 'boolean',
  ...
  protected parseOptions(optionsString: string): ListboxOption[] {
    try {
