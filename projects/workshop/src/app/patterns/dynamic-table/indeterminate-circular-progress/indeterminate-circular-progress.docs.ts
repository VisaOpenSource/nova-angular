...
/**
 * Dynamic table with circular progress indicator for loading states
 */
/** #patterns **/
@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  selector: 'nova-workshop-dynamic-table-indeterminate-circular-progress',
...
export class IndeterminateCircularProgressDynamicTableComponent {
