...
/**
 * Horizontal top bar for mixed navigation layouts.
 * Works with vertical sidebar to provide combined navigation structure.
 * #patterns #isSubComponent
 **/
@Component({
  selector: 'nova-workshop-horizontal-mixed-nav-layout',
  templateUrl: './horizontal-mixed-nav-layout.docs.html',
  standalone: true,
...
export class HorizontalMixedNavLayoutComponent {
  ...
  mobileMenuContainer = viewChild(FloatingUIContainer);
  ...
  readonly mobileBreakpoint = 1050;
